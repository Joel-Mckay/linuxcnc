...
// Available at http://www.open.com.au/mikem/arduino/AccelStepper
  ...
  #define stepperC true // enable to bind this stepper to axis5 (C axis).
  #define stepperU true // enable to bind this stepper to axis6 (U axis).
  #define stepperV true // enable to bind this stepper to axis7 (V axis).
  ...
  #define stepsPerUnitA 0.9
  #define stepsPerUnitB 0.9
  #define stepsPerUnitC 0.9
  #define stepsPerUnitU 0.9
  #define stepsPerUnitV 0.9
  #define stepsPerUnitW 0

  // Max speed in units per second. Speed will also be influenced by host.
  #define unitsPerSecondX 0.12
  #define unitsPerSecondY 0.12
  #define unitsPerSecondZ 0.12
  #define unitsPerSecondA 100
  #define unitsPerSecondB 100
  #define unitsPerSecondC 100
  #define unitsPerSecondU 100
  #define unitsPerSecondV 100
  #define unitsPerSecondW 0

  // Max acceleration in units per second.
  #define accelPerSecondX 0.36
  #define accelPerSecondY 0.36
  #define accelPerSecondZ 0.36
  #define accelPerSecondA 300
  #define accelPerSecondB 300
  #define accelPerSecondC 300
  #define accelPerSecondU 300
  #define accelPerSecondV 300
  ...
  // for documentation on how to setup different kinds of steppers.
    #if stepperX
      AccelStepper stprX(1, 62, 37); //type, stepPin, dirPin
    #endif
    #if stepperY
      AccelStepper stprY(1, 63, 39); 
    #endif
    #if stepperZ
      AccelStepper stprZ(1, 64, 41);
    #endif
    #if stepperA
      AccelStepper stprA(1, 67, 50);
    #endif
    #if stepperB
      AccelStepper stprB(1, 68, 51);
    #endif
    #if stepperC
      AccelStepper stprC(1, 69, 53);
    #endif
    #if stepperU
      AccelStepper stprU(1, 66, 45);
    #endif
    #if stepperV
      AccelStepper stprV(1, 65, 43);
    #endif
    #if stepperW
...
///// pinInversion section /////
 ...
 // example: stepper#.setPinsInverted(step, direction, enable);
    ...
    #endif
    #if stepperB
      stprB.setPinsInverted(false, false, true);
    #endif
    #if stepperC
      stprC.setPinsInverted(false, false, true);
    #endif
    #if stepperU
      stprU.setPinsInverted(false, false, true);
    #endif
    #if stepperV
      stprV.setPinsInverted(false, false, true);
    #endif
    #if stepperW
      stprW.setPinsInverted(false, false, true);
    #endif
  #endif
///// enablePins section /////
  #if enablePins
  // example: stepper#.setEnablePin(q); change 'q' to the enable pin for this axis.
    #if stepperX
      stprX.setEnablePin(46);
    #endif
    #if stepperY
      stprY.setEnablePin(46);
    #endif
    #if stepperZ
      stprZ.setEnablePin(46);
    #endif
    #if stepperA
      stprA.setEnablePin(46);
    #endif
    #if stepperB
      stprB.setEnablePin(46);
    #endif
    #if stepperC
      stprC.setEnablePin(46);
    #endif
    #if stepperU
      stprU.setEnablePin(46);
    #endif
    #if stepperV
      stprV.setEnablePin(46);
    #endif
    #if stepperW
      stprW.setEnablePin(46);
    #endif
  #endif
