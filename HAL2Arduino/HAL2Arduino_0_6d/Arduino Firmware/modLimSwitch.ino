...
#define useLimitSwitches true
  ...
  #define CaxisEnableSwitches true
  ...
  #define xMinSwitch 0
  #define xMaxSwitch 0
  #define xHomeSwitch 47
  
  #define yMinSwitch 0
  #define yMaxSwitch 0
  #define yHomeSwitch 40
  
  #define zMinSwitch 0
  #define zMaxSwitch 0
  #define zHomeSwitch 36
  
  #define aMinSwitch 0
  #define aMaxSwitch 0
  #define aHomeSwitch 52
  
  #define bMinSwitch 0
  #define bMaxSwitch 0
  #define bHomeSwitch 42
  
  #define cMinSwitch 0
  #define cMaxSwitch 0
  #define cHomeSwitch 38
  
  #define uMinSwitch 0
  #define uMaxSwitch 0
  //TAUX
  #define uHomeSwitch 56
  
  #define vMinSwitch 0
  #define vMaxSwitch 0
  //TE3
  #define vHomeSwitch 57
  
  #define wMinSwitch 0
  #define wMaxSwitch 0
  //TE2
  #define wHomeSwitch 58
  ...
  #define xVirtualMin 0
  #define xVirtualMax 4
  #define xVirtualHome 0.0
  #define yVirtualMin 0
  #define yVirtualMax 4
  #define yVirtualHome 0.0
  #define zVirtualMin 0
  #define zVirtualMax 4
  ...
  #define cVirtualMin -180.0
  #define cVirtualMax 180.0
  #define cVirtualHome 0.0
  #define uVirtualMin 180.0
  #define uVirtualMax -180.0
  #define uVirtualHome 0.0
  #define vVirtualMin -180.0
  #define vVirtualMax 180.0
